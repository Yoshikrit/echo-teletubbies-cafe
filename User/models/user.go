...
type UserUpdate struct {
	Role_Id    int       `json:"Role_Id"            validate:"omitempty,gt=0"`
	FName      string    `json:"User_FName"         validate:"omitempty"`
	LName      string    `json:"User_LName"         validate:"omitempty"`
	Email      string    `json:"User_Email"         validate:"omitempty,email"`
	Password   string    `json:"User_Password"      validate:"omitempty"`
	Sex        string    `json:"User_Sex"           validate:"omitempty"`
	TelNo      string    `json:"User_TelNo"         validate:"omitempty"`
	Salary     float64   `json:"User_Salary"        validate:"omitempty,numeric"`
	Address    string    `json:"User_Address"       validate:"omitempty"`
	WorkStatus string    `json:"User_WorkStatus"    validate:"omitempty"`
	BirthDate  time.Time `json:"User_BirthDate"     validate:"omitempty"`
}
